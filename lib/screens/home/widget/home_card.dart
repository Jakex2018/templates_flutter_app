            ...
            child: GestureDetector(
              onTap: () async {
                ...
                if (imageUrl == null || imageUrl.isEmpty) {
                  // Show an alert dialog if the image URL is empty
                  showDialog(
                    context: context,
                    builder: (context) {
                      return AlertDialog(
                        ...
                        content:
                            const Text('This category does not have an image.'),
                        actions: [
                          TextButton(
                  ...
                  // Exit the onTap function to prevent further navigation
                  return;
                }
              ...
              child: Container(
                ...
                child: Stack(children: [
                  ...
                  Positioned(
                      top: 40.h, left: 220.w, child: categoryStream(category))
                ]),
              ),
            ),
          );
